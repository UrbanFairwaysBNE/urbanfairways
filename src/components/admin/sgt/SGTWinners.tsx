...
<head>
  ...
  <style>
    @import url("https://fonts.googleapis.com/css2?family=Montserrat:wght@600;700&family=Montserrat:wght@400;600&display=swap");
  </style>
</head>
...
<table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px; width:100%;">
  ...
  <!-- BODY -->
  <tr>
    <td style="background-color:#F4F1EB; padding:26px 22px; border-left:1px solid rgba(47,49,52,0.12); border-right:1px solid rgba(47,49,52,0.12);">
      <h1 style="margin:0 0 18px; font-family:Montserrat, Impact, Arial Black, sans-serif; font-size:34px; line-height:1.1; color:#1C1F24; text-align:center;">
        🏆 MONTHLY WINNER!
      </h1>
      <p style="margin:0 0 14px; font-family:Montserrat, Arial, sans-serif; font-size:18px; color:#1C1F24;">
        Congratulations <strong>{{first_name}}</strong>!
      </p>
      <p style="margin:0 0 18px; font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:1.6; color:#1C1F24;">
      ...
      <div style="background-color:#ffffff; border:1px solid rgba(47,49,52,0.15); border-radius:12px; padding:20px; margin:22px 0; text-align:center;">
        <p style="font-size:14px; color:#1C1F24; margin:0 0 8px 0; font-family:Montserrat, Arial, sans-serif; opacity:0.75;">Your Prize</p>
        <p style="font-family:Montserrat, Impact, Arial Black, sans-serif; font-size:28px; color:#5F6F52; margin:0;">{{prize_description}}</p>
      </div>
      <p style="margin:0 0 18px; font-family:Montserrat, Arial, sans-serif; font-size:16px; line-height:1.6; color:#1C1F24;">
        Pop in next time you're at ${t.venue_name} to collect your prize. Keep up the great golf!
      </p>
      <p style="margin:24px 0 0; font-family:Montserrat, Arial, sans-serif; font-size:16px; color:#1C1F24;">
