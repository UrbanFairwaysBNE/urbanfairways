  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-[hsl(128,20%,85%)] shadow-sm p-5 flex flex-col">
      <div className="flex items-center gap-2 text-[hsl(128,20%,40%)] text-sm uppercase tracking-wide font-semibold mb-2">
        <Icon className="h-4 w-4 text-[hsl(93,15%,38%)]" />
        {label}
      </div>
...
function MiniTable({
  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-[hsl(128,20%,85%)] shadow-sm overflow-hidden flex flex-col">
      <div className="px-4 py-2 bg-[hsl(218,13%,13%)] text-white font-bold text-base text-center">
        {title}
      </div>
      <div className="divide-y divide-[hsl(128,20%,90%)] flex-1">
        ...
        {top.map((r, i) => {
          ...
          return (
            <div
              key={`${r.user_name}-${i}`}
              className={i === 0 ? "grid grid-cols-12 gap-2 items-center px-4 py-2.5 bg-[hsl(40,29%,97%)]" : "grid grid-cols-12 gap-2 items-center px-4 py-2.5"}
            >
...
export default function EmbedTVStats({ variant }: { variant: "current" | "previous" }) {
  ...
  if (busy) {
    return (
      <div className="min-h-screen bg-[hsl(40,29%,94%)] flex items-center justify-center">
        <Loader2 className="h-16 w-16 text-[hsl(93,15%,38%)] animate-spin" />
      </div>
    );
  }

  return (
    <div className="min-h-screen bg-[hsl(40,29%,94%)] p-6 flex flex-col gap-4">
      {/* Header */}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        ...
        <div className="bg-white rounded-2xl border-2 border-[hsl(128,20%,85%)] shadow-sm p-5 flex flex-col">
          <div className="flex items-center gap-2 text-[hsl(128,20%,40%)] text-sm uppercase tracking-wide font-semibold mb-2">
            <Crosshair className="h-4 w-4 text-[hsl(93,15%,38%)]" />
            Nearest to Pin
          </div>
          <p className="text-2xl font-bold text-[hsl(218,13%,13%)] truncate">
